...
```
cd existing_repo
git remote add origin https://gitlab.bicarus.xyz/7k/7k-ts-sdk.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.bicarus.xyz/7k/7k-ts-sdk/-/settings/integrations)
